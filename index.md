...
1. Let the users point-to-point match a screenshot of the video to the digital field for birdseye transformation.
2. Display a link in the frontend to directly download the output videos.
3. Allow users to choose from more options and statistics to be output.

# Further Discussion
## Learnings
1. New technologies such as OpenCV, YOLOv3, DeepSort, Anvil.
2. Became more comfortable reading technical papers.
3. Connecting large amounts of code to work together seamlessly.

## Future Working Directions
1. Implement more detailed recognition to match the player on the field with their name and number.
2. Generate more statistics based on the video, like the ball possession statistics.
3. Make predictions – like where the ball is going to land and which player may take the possession.
